...
import org.example.operators_assignment.InstanceOf;
...
//-----------------------------------    String Comparison Program    -------------------------------------------------
        ...
        // == referece -address  | .equals content compariso
        System.out.println(s1 == s2); // true
        System.out.println(s1.equals(s2)); // true

        String s3 = new String("shu1");

        // scp pointing to same content BUT s3 created using new | so new address/reference
        System.out.println(s2 == s3); // false
        System.out.println(s2.equals(s3));// true

        scp pointing to same content BUT s3 created using replace
        String is immutable in Java, so logically every replace() call should return a new object.
        But the JDK has a small optimization inside String.replace(char, char): before allocating anything,
        it checks if (oldChar != newChar).
        If they're equal, there's nothing to actually change, so it just return this — same reference,
        no new allocation.
        If they differ, it builds a new backing array and returns a genuinely new String.

        String s4 = "naveen";

        String s5_1 =s4.replace("n","n");//scp - old char == new char
        String s5_2 =s4.replace('n','n');//scp - old char == new char
        String s5 =s4.replace("n","N");// heap - old char != new char

        System.out.println(s4 == s5_1);// true
        System.out.println(s4 == s5_2);// true
        System.out.println(s4 == s5);// false
        System.out.println(s4.equals(s5));// false - diff content
 ...
 */
        ...
        System.out.println(str.valueOf(10.00));
        System.out.println(str.valueOf('a'));
        System.out.println(str.valueOf(true));
        System.out.println(str.valueOf("abc"));
        // equivalent to 10+"" -> covert to String Object
        ...
        String s11 = new String("javaguides");// heap
        String s22 = new String("javaguides");// heap
